...
while(True):
    ...
    # for it_plane in range(2):
        ...
        for it_z in range(n_steps):
            ...
            wz = (obs.width[1]-obs.width[0])/obs.height * z_vals[it_z] + obs.width[0]
            ...
            for it_xy in range(n_steps):
                ...
                position = obs.get_surface_position(position, inflation_parameter=dya[it_plane, :],
                                                    plane_index=it_plane, in_global_frame=True)
