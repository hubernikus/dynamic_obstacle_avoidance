...
def main(options=[0], N_resol=100, saveFigures=False):
    for option in options:
        ...
        if option == -6:
            ...
            obs.append(
                Ellipse(
                    a=[0.7, 0.7], p=[1, 1], x0=[0, 1.5], th_r=0, w=10, sf=1, xd=[0, 0]
                )
            )
            obs.append(
                Ellipse(
                    a=[0.7, 0.7], p=[1, 1], x0=[1, 1.5], th_r=0, w=10, sf=1, xd=[0, 0]
                )
            )
        ...
        if option == -4:
            ...
            pos_attractor1 = [1.0, 1.5]
            pos_attractor2 = [1.0, -1.5]
            ...
            fig_mod, ax_mod = Simulation_vectorFields(
                ...
                N_resol,
                obs,
                pos_attractor=pos_attractor1,
                saveFigure=saveFigures,
                figName="linearSystem_avoidanceCube",
                noTicks=False,
                draw_vectorField=False,
                points_init=points_attr2,
                automatic_reference_point=False,
            )
        ...
        if option == -3:
            ...
            obs[1].set_reference_point(
                obs[0].get_reference_point(in_global_frame=True), in_global_frame=True
            )
        ...
        if option == 1:
            ...
            obs.append(
                Ellipse(a=[1.1, 1.4], p=[2, 2], x0=[3.0, 1.3], th_r=0 / 180 * pi, sf=1)
            )

            obs.append(
                Ellipse(a=[2, 0.4], p=[2, 2], x0=[2.5, 3], th_r=-20 / 180 * pi, sf=1)
            )
        ...
        if option == 2:
            ...
            fig, ax = Simulation_vectorFields(
                ...
                pos_attractor=pos_attractor,
                saveFigure=saveFigures,
                figName="linearCombination_obstacle0",
                noTicks=True,
                streamColor=col1,
                obstacleColor=[col1],
                alphaVal=0.7,
            ...
            Simulation_vectorFields(
                ...
                pos_attractor=pos_attractor,
                saveFigure=saveFigures,
                figName="linearCombination_obstacle_overlay",
                noTicks=True,
                streamColor=col2,
                obstacleColor=[col2],
                figHandle=[fig, ax],
            ...
            Simulation_vectorFields(
                ...
                pos_attractor=pos_attractor,
                saveFigure=saveFigures,
                figName="linearCombination_obstaclesBoth",
                noTicks=True,
            )
        ...
        if option == 4:
            ...
            Simulation_vectorFields(
                ...
                pos_attractor=pos_attractor,
                saveFigure=saveFigures,
                figName="twoEllipses_concaveRegion_front",
            )
            ...
            Simulation_vectorFields(
                ...
                pos_attractor=pos_attractor,
                saveFigure=saveFigures,
                figName="twoEllipses_concaveRegion_top",
            )
        ...
        if option == 5:
            ...
            Simulation_vectorFields(
                ...
                pos_attractor=pos_attractor,
                saveFigure=saveFigures,
                figName="movingEllipse_notMoving",
                obs_avoidance_func=obs_avoidance_radialDisplace,
            )
        ...
        if option == 7:
            ...
            Simulation_vectorFields(
                ...
                pos_attractor=pos_attractor,
                saveFigure=saveFigures,
                figName="ellipseCircle_tailEffectOff",
                obs_avoidance_func=obs_avoidance_interpolation_moving,
                showLabel=False,
                figureSize=figSize,
            )
            ...
            Simulation_vectorFields(
                ...
                pos_attractor=pos_attractor,
                saveFigure=saveFigures,
                figName="ellipseCircle_tailEffectOn",
                obs_avoidance_func=obs_avoidance_interpolation_moving,
                showLabel=False,
                figureSize=figSize,
            )
        ...
        if option == 9:
            ...
            for n in range(len(x0_list)):
                obs.append(
                    Ellipse(a=[0.5, 0.5], p=[1, 1], x0=x0_list[n], th_r=0, sf=2.0)
                )
        ...
        if option == 8:
            ...
            if saveFigures:
                plt.savefig(
                    "fig/" + "ellipseCenterMiddle_centerLine_pres_colMap" + ".eps",
                    bbox_inches="tight",
                )

            rat = -0.9
            obs[0].center_dyn = [
                x0[0] - rat * np.sin(th_r) * a[1],
                x0[1] - rat * np.cos(th_r) * a[1],
            ]
            Simulation_vectorFields(
                xlim,
                ...
                pos_attractor=pos_attractor,
                saveFigure=False,
                figName="ellipse_centerNotMiddle",
                noTicks=True,
                showLabel=False,
                colorCode=True,
            )
            ...
            if saveFigures:
                plt.savefig(
                    "fig/" + "ellipseCenterNotMiddle_centerLine_pres_colMap" + ".eps",
                    bbox_inches="tight",
                )
