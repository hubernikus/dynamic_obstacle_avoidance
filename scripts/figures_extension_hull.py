    ...
    for option in options:
        ...
        if option==0:
            ...
            fig_mod, ax_mod = Simulation_vectorFields(
                ...
                noTicks=True, showLabel=False, figureSize=(6, 5), reference_point_number=False,
                draw_vectorField=True, automatic_reference_point=False,
                point_grid=N_resol)
            ...
            fig_mod, ax_mod = Simulation_vectorFields(
                ...
                figName='dynamic_extension_x{}_y{}'.format(int(ref[0]), int(ref[1])),
                noTicks=True, showLabel=False, figureSize=(6, 5), reference_point_number=False,
                 automatic_reference_point=False, point_grid=N_resol, show_streamplot=True,
            )
