...
def main(options=[0], N_resol=100, saveFigures=False):
    for option in options:
        ...
        if option==5:
            ...
            Simulation_vectorFields(xlim, ylim, N_resol, obs, xAttractor=xAttractor, saveFigure=saveFigures, figName='movingEllipse_notMoving', obs_avoidance_func=obs_avoidance_radialDisplace)
