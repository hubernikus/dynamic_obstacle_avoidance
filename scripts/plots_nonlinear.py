...
def main(n_resol=90, *args, **kwargs):
    ...
    for ii in range(len(obs)):
        ...
        im = plt.imshow(masked_array, cmap=cmap, vmin=value_min, vmax=value_max,
        ...
        plt.plot(reference_point[0],reference_point[1], 'k+', linewidth=18, markeredgewidth=4, markersize=13)
