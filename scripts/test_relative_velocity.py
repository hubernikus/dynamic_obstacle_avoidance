...
from dynamic_obstacle_avoidance.visualization.vector_field_visualization import plot_obstacles, Simulation_vectorFields  #
...
def test_get_relative_speed_around(n_grid_num=40):
    ...
    Simulation_vectorFields(
        ...
        draw_vectorField=True, show_streamplot=True,
