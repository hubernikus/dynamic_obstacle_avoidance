...
def main(save_figure=False, n_points=100, case=[1]):
    ...
    if 1 in case:
        ...
        # plt.figure()
        plt.plot(surface_points_1[0, :], surface_points_1[1, :], 'k',
                 # label='Ellipse 1',
                 )
        plt.plot(surface_points_2[0, :], surface_points_2[1, :], 'k',
                 # label='Ellipse 2',
                 )
        plt.plot(
            surface_points_1[0, ii_min], surface_points_1[1, ii_min],
            '*r', label='Minimum at $\phi_1$={} / $\phi_2$ = {}'.format(
            np.round(phi_1[ii_min]*180/pi,0), np.round(phi_2[jj_min]*180/pi, 0)))
        ...
        if 2 in case:
            plt.plot(
                surface_point_1[0], surface_point_1[1], '*g',
