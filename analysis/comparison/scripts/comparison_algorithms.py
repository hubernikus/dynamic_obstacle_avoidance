...
def visualize_f1():
    ...
    plot_dynamical_system_quiver(dynamical_system=f1_dynamics,
...
def visualize_f2():
    ...
    plot_dynamical_system_quiver(dynamical_system=f2_dynamics,
                                     x_lim=[-6.0, 6.0], y_lim=[-5.0, 5.0], axes_equal=True)
...
def plot_comparision_lyapunov_comparison_streamplot(
    ...
    if show_streamplot:
        fig, ax = Simulation_vectorFields(
            ...
            show_streamplot=True, noTicks=False,
...
def plot_comparision_lyapunov_comparison(
    ...
    for pos in start_position:
        ...
        for ii in range(it_max-1):
            ...
            positions[:, ii+1] = positions[:, ii] + delta_time*velocities[:, ii]
        
        ax.plot(positions[0, :ii], positions[1, :ii], '-',
                color='k',
                # color='#A9A9A9',
                )
