...
from dynamic_obstacle_avoidance.obstacle_avoidance.ellipse_obstacles import Obstacle
...
class AgentQOLO(Obstacle):
    ...
    def __init__(self, robot_margin=0, attractor_position=None, ax=None, image_dir=None, **kwargs):
        if sys.version_info > (3, 0):
            super().__init__(name="QOLO", **kwargs)
        else:
            super(AgentQOLO, self).__init__(
                name="QOLO", **kwargs
                )
    ...
    def iterate_pos(self, obstacle_list, ds_initial=None, attractor=None, dt=0.1):
        ...
        self.orientation = np.arctan2(self.linear_velocity[1],
