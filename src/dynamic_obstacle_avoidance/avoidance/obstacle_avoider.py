...
class ObstacleAvoiderWithInitialDynamcis():
    def __init__(self, initial_dynamics: DynamicalSystem, environment: BaseContainer,
...
class DynamicModulationAvoider(ObstacleAvoiderWithInitialDynamcis):
    ...
    def avoid(self, position: np.ndarray, initial_velocity: np.ndarray, const_speed: bool = True
              ) -> np.ndarray:
