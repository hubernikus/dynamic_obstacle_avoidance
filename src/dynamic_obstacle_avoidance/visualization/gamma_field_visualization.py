...
def gamma_field_visualization(obstacle, n_resolution=30, x_lim=None, y_lim=None,
                              dim=2, fig=None, ax=None, grid_number=None):
...
def gamma_field_multihull(obstacle_list, it_obs, n_resolution=30, x_lim=None, y_lim=None,
                          dim=2, ax=None):
