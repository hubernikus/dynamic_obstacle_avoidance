    ...
    for it_step in range(n_max_it-1):
        for ii in np.arange(n_points)[active_trajectories]:
            ...
            if np.linalg.norm(modulated_velocity) < zero_vel_margin:
                print(f"Trajectory {ii} ist stuck at step {it_step} and "
