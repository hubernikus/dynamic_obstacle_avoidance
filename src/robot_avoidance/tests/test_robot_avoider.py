...
class TestRobotAvoider(unittest.TestCase):
    def test_evaluation_points(self, visualize=False):
        ...
        my_avoider = RobotArmAvoider(obstacle_avoider=dynamic_avoider, robot_arm=my_robot)
    ...
    def test_evaluation_weight(self, visualize=False):
        ...
        joint_weight, point_weight_list = my_avoider.get_influence_weight_at_points(points)
